...
- If you notice WINE games aren't displaying correctly (ie; portions are cut off the screen), go into winecfg and make sure WINE's DPI matches XFCE4's DPI (in my case it didn't on a fresh install, matching theme to 96 worked perfectly).
